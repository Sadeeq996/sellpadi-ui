...
export class SignupPage implements OnInit {
  ...
  signup() {
    ...
    //   },
    //   (error) => {
    //     this.presentToast('signup Failed', 'An unexpected error occurred. Please try again later.', 'toast-error');
    //   }
    // );
  ...
  onGoogleSignup() {
    this.presentToast('Info', 'Google signup is not yet implemented.', 'toast-warning');
  }
